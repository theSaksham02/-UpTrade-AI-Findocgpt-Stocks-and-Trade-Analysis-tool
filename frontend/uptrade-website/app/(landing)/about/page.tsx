...
export default function AboutPage() {
    ...
    return (
        <div ref={containerRef} className="bg-transparent min-h-screen">
                ...
                <div className="text-center z-10 px-6">
                    ...
                    >
                        <TextScramble
                            ...
                            className="text-5xl md:text-8xl font-bold text-white block mb-6 tracking-tight"
                            trigger="mount"
                            speed={40}
                        />
                    </motion.div>
                    ...
                    <TextDecode
                        ...
                        className="text-xl md:text-2xl text-[#868993] max-w-2xl mx-auto mt-8"
                        speed={20}
                    />
                </div>

                {/* Parallax Floating Elements */}
                <motion.div style={{ y: y1 }} className="absolute top-1/4 left-[10%] w-32 h-32 border border-[#2962FF]/20 rounded-full blur-[1px]" />
                <motion.div style={{ y: y2 }} className="absolute bottom-1/4 right-[15%] w-48 h-48 border border-[#00FF99]/10 rounded-full blur-[1px]" />
            </section>
            ...
            {/* Stats with Animated Counters - Seamless */}
            <section className="py-24 border-y border-[#2a2e39]/30 bg-[#131722]/20 backdrop-blur-sm">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {team.map((person, i) => (
                            <motion.div
                                ...
                                className="group relative bg-[#131722]/30 backdrop-blur-md border border-[#2a2e39]/50 rounded-2xl overflow-hidden hover:border-[#2962FF]/50 transition-colors"
                            >
                                {/* Image placeholder with gradient */}
                                <div className="h-64 bg-gradient-to-b from-[#2962FF]/10 to-transparent relative overflow-hidden">
                                    <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-20" />
                                    <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-[#131722]/50 to-transparent" />
                                </div>
                                ...
                                <div className="p-6 relative">
                                    ...
                                    <div className="h-0 overflow-hidden group-hover:h-auto transition-all">
                                        <p className="text-[#868993] text-sm pt-2 border-t border-[#2a2e39]/50">
            ...
            <section className="py-24 overflow-hidden border-t border-[#2a2e39]/30">
